...
class QueueModel:
    ...
    def tick(self):
        """
        вызывается каждую секунду, в нем надо делать всю основную логику,
        т.е. засекать время, и когда пройдет 40 сек, выбирать следующего стримера из очереди
        """
        if self.elapsed < 40:
            self.elapsed += 1
        else:
    ...
    def select_next(self):
        """
        Возвращает следующего по очереди, т.е. первого в списке
        :return:
        """
